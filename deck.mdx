...
# Who am I? 😁
![Shahzaib's Avatar](static/profile.jpg)
...
![npm trends about top JS frameworks](static/npm-trends.png)
...
![Class Component](static/class-component.png)

![Functional Component](static/functional-component.png)
...
![Logic split across component](static/code-split-among-lifecycle.png)
...
![Classes are hard to minify and tree-shake](static/classes-tree-shaking.png)
...
![Class Component](static/counter-class-component.png)

![Functional Component](static/counter-functional-component.png)
...
<img src="static/todo-with-class.png" />
<img src="static/todo-with-hooks.png" />
...
![Code sharing is different](static/code-sharing.png)
...
![Content Normal](static/content-normal.png)

![Sidebar Normal](static/sidebar-normal.png)
...
![withJoke HOC](static/withjoke-hoc.png)

---

export default Split

![Content HOC](static/content-hoc.png)

![Sidebar HOC](static/sidebar-hoc.png)
...
![HOC Hell](static/hoc-wrapper-hell.png)
...
![Render Prop Joke](static/joke-render-prop.png)

---

export default Split

![Content Render Prop](static/content-render-prop.png)

![Sidebar Render Prop](static/sidebar-render-prop.png)
...
![Render Prop Nesting](static/render-prop-nesting.png)
...
![Custom useJoke Hook](static/usejoke.png)

---

export default Split

![Custom Hook Content](static/content-hook.png)

![Custom Hook Sidebar](static/sidebar-hook.png)
